...
import com.gtcc.library.R.id;
import com.gtcc.library.R.layout;
import com.gtcc.library.R.menu;
import com.gtcc.library.R.string;
import com.gtcc.library.TestActivity;
...
public class LoginActivity extends Activity {
	...
	public class UserLoginTask extends AsyncTask<JSONObject, Void, Boolean> {
		...
		protected Boolean doInBackground(JSONObject... params) {
			...
			try {
				isSuccessful = WebServiceUserProxy.isLogin(params[0]);
