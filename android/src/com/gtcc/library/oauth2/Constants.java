...
public class Constants {
	...
	public static final String DOUBAN_API_KEY = "04629e3361e9ff6b0d27da9a25bdfe41";
	public static final String DOUBAN_SECRET_KEY = "dfee9ee1dbe96620";
	...
	public static final String DOUBAN_REDIRECT_URL = "http://myapp.com/callback";

	public static final String DOUBAN_API_URL_PREFIX = "https://api.douban.com";
	public static final String DOUBAN_API_USER_BOOKS_COLLECTION = "/v2/book/user/%s/collections";
	public static final String DOUBAN_API_USER_INFO = "/v2/user/~me";
	public static final String DOUBAN_API_BOOK_INFO = "/v2/book/";
	public static final String DOUBAN_API_BOOK_SEARCH = "/v2/book/search";
	public static final String DOUBAN_API_BOOK_SEARCH_KEY = "q";
	...
	public static final String WEIBO_REMOTE_SERVICE = "com.sina.weibo.remotessoservice";
