...
public class ImageFetcher extends ImageWorker {
        ...
        synchronized (mHttpDiskCacheLock) {
            ...
            if (mHttpDiskCache != null) {
                try {
                    ...
                    if (snapshot == null) {
                    	LogUtils.LOGD(TAG, "processBitmap, not found in http cache, downloading...");
                	...
                	LogUtils.LOGE(TAG, "processBitmap - " + e);
    ...
    public static byte[] downloadBitmapToMemory(String urlString, int maxBytes) {
    	LogUtils.LOGD(TAG, "downloadBitmapToMemory - downloading - " + urlString);
        ...
        try {
        	...
        	LogUtils.LOGE(TAG, "Error in downloadBitmapToMemory - " + e);
        } finally {
    ...
    public static File downloadBitmapToFile(String urlString, File cacheDir) {
    	LogUtils.LOGD(TAG, "downloadBitmap - downloading - " + urlString);
        ...
        synchronized (mHttpDiskCacheLock) {
            if (mHttpDiskCache != null && !mHttpDiskCache.isClosed()) {
                try {
                	...
                	LogUtils.LOGE(TAG, "clearCacheInternal - " + e);
                }
                mHttpDiskCache = null;
        ...
        synchronized (mHttpDiskCacheLock) {
            if (mHttpDiskCache != null) {
                try {
                	...
                	LogUtils.LOGE(TAG, "closeCacheInternal - " + e);
                }
            }
        }
    }
